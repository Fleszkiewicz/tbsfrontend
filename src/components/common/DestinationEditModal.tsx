...
import { IoCloseOutline, IoLocationOutline, IoCalendarOutline } from "react-icons/io5";
...
export const DestinationEditModal = ({ isOpen, onClose, onSave, initialData }: Props) => {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-[1250px] bg-white rounded-[20px] shadow-2xl animate-in zoom-in-95 duration-200 overflow-hidden flex flex-col max-h-[90vh]"
      ...
      >
        ...
        <div className="p-6 md:p-8 overflow-y-auto flex-1 " style={{ scrollbarWidth: "none" }}>
          {/* Dates */}
          <div className="mb-8">
            ...
            <table className="w-full text-[14px] text-left border-collapse">
              <thead>
                <tr className="bg-[#1D1D1F] text-white">
                  ...
                  <th className="px-4 py-2.5 font-semibold text-center w-[60px]">Acciones</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-2 md:px-4 py-2.5 align-top text-center">
                      <button
                        ...
                        className="p-1.5 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors mt-0.5 inline-flex"
